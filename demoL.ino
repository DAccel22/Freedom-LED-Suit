...
Adafruit_NeoPixel RA = Adafruit_NeoPixel(arm_LED_num, RA_pin, NEO_GRB + NEO_KHZ800); // Initialize RA LED strip
Adafruit_NeoPixel LA = Adafruit_NeoPixel(arm_LED_num, LA_pin, NEO_GRB + NEO_KHZ800); // Initialize LA LED strip
Adafruit_NeoPixel LL = Adafruit_NeoPixel(leg_LED_num, LL_pin, NEO_GRB + NEO_KHZ800); // Initialize LL LED strip
Adafruit_NeoPixel RL = Adafruit_NeoPixel(leg_LED_num, RL_pin, NEO_GRB + NEO_KHZ800); // Initialize RL LED strip
